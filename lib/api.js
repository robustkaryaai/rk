...
export const userAPI = {
    ...
    // Sync Clerk user to Appwrite users collection
    async syncUserToAppwrite(clerkUser) {
        try {
            ...
            if (existing.documents && existing.documents.length > 0) {
                ...
                console.log('[User Sync] Updated user in Appwrite:', clerkUser.id);
            } else {
                // Create new user
                ...
                console.log('[User Sync] Created user in Appwrite:', clerkUser.id);
            }
