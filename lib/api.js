    ...
    async syncUserToAppwrite(user, avatarUrl = '', providerAccessToken = null, providerRefreshToken = null) {
        try {
            ...
            try {
                ...
                if (providerAccessToken) updateData.googleAccessToken = providerAccessToken;
                if (providerRefreshToken) updateData.googleRefreshToken = providerRefreshToken;
                ...
                if (providerAccessToken) userData.googleAccessToken = providerAccessToken;
                if (providerRefreshToken) userData.googleRefreshToken = providerRefreshToken;
